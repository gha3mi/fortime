...
module fortime
   ...
   type :: timer
      ...
      real    :: elapsed_time     ! Elapsed time in seconds
   contains
...
contains
   ...
   impure subroutine timer_stop(this, nloops, message)
      ...
      if (.not.present(nloops)) this%elapsed_time = real(this%clock_elapsed) / real(this%clock_rate)
      if (     present(nloops)) this%elapsed_time = real(this%clock_elapsed) / real(this%clock_rate) / real(nloops)
